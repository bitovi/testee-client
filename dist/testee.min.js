...
define("testee-client/index",function(n,i,e){n("core-js/client/core");var t={defaults:n("lodash/defaults"),delay:n("lodash/delay")},s=n("socket.io-client/socket.io"),o=n("feathers/client"),a=n("feathers-socketio/client"),c=n("testee-client/docready"),w=n("testee-client/runner"),r=n("testee-client/adapters/qunit"),d=n("testee-client/adapters/jasmine-legacy"),u=n("testee-client/adapters/jasmine"),m=n("testee-client/adapters/mocha");c(function(){var n=window.Testee=window.Testee||{};n.app||(n.socket=n.socket||s(),n.app=o().configure(a(n.socket))),t.defaults(n,{runs:n.app.service("api/runs"),suites:n.app.service("api/suites"),tests:n.app.service("api/tests"),coverages:n.app.service("api/coverages"),runner:function(){return this._runner||(this._runner=w(n)),this._runner},canInitialize:function(){return window.QUnit||window.jasmine&&window.jasmine.version_&&1===window.jasmine.version_.major||window.jasmine&&window.jasmine.version&&"2"===window.jasmine.version.split(".")[0]||window.mocha&&window.Mocha},init:function(){window.QUnit&&this.initQUnit(window.QUnit),window.jasmine&&window.jasmine.version_&&1===window.jasmine.version_.major&&this.initJasmine1(window.jasmine),window.jasmine&&window.jasmine.version&&"2"===window.jasmine.version.split(".")[0]&&this.initJasmine(window.jasmine),window.mocha&&window.Mocha&&this.initMocha(window.mocha)},initQUnit:function(n){r(n,this.runner(),window)},initJasmine1:function(n){d(n,this.runner(),window)},initJasmine:function(n){u(n,this.runner(),window)},initMocha:function(n){m(n||window.mocha,this.runner(),window)},connect:new Promise(function(i){var e=function(){t.delay(function(){i(n.socket)},250)};n.socket.connected?e():n.socket.on("connect",e)})}),n.canInitialize()&&n.init()})});
/*[global-shim-end]*/

...
/*feathers-commons@0.7.5#lib/arguments*/
...
/*feathers-commons@0.7.5#lib/utils*/
...
/*feathers-commons@0.7.5#lib/hooks*/
...
/*feathers-commons@0.7.5#lib/commons*/
...
/*feathers@2.0.1#lib/mixins/promise*/
...
/*rubberduck@1.1.0#lib/rubberduck*/
...
/*feathers@2.0.1#lib/mixins/event*/
...
/*feathers@2.0.1#lib/mixins/normalizer*/
...
/*feathers@2.0.1#lib/mixins/index*/
...
/*feathers@2.0.1#lib/application*/
define('feathers/lib/application', function (require, exports, module) {
    ...
    exports.default = {
        ...
        use: function use(location) {
            var service = void 0, middleware = Array.from(arguments).slice(1).reduce(function (middleware, arg) {
...
/*feathers@2.0.1#lib/client/express*/
...
/*feathers@2.0.1#lib/client/index*/
...
/*feathers-errors@2.4.0#lib/index*/
...
/*feathers-rest@1.5.0#lib/client/base*/
...
/*feathers-rest@1.5.0#lib/client/jquery*/
...
/*feathers-rest@1.5.0#lib/client/superagent*/
...
/*feathers-rest@1.5.0#lib/client/request*/
...
/*feathers-rest@1.5.0#lib/client/fetch*/
...
/*feathers-rest@1.5.0#lib/client/index*/
...
/*superagent@2.3.0#lib/is-object*/
...
/*superagent@2.3.0#lib/request-base*/
...
/*superagent@2.3.0#lib/request*/
define('superagent/lib/request', function (require, exports, module) {
...
define('superagent/lib/client', function (require, exports, module) {
    ...
    ;
    var request = module.exports = require('superagent/lib/request').bind(null, Request);
...
(function (f) {
    if (typeof exports === 'object' && typeof module !== 'undefined') {
        ...
        define('socket.io-client/socket.io', [], f);
    } else {
        var g;
        if (typeof window !== 'undefined') {
            g = window;
            ...
            function (_dereq_, module, exports) {
                (function (global) {
                    ...
                    (function () {
                        ...
                        if (isLoader) {
                            define('socket.io-client/socket.io', function () {
                                return JSON3;
                            });
                        }
                    }.call(this));
...
/*feathers-socketio@1.4.1#lib/client*/
...
/*testee-client@0.4.0-pre.5#runner*/
...
/*testee-client@0.4.0-pre.5#guid*/
...
/*testee-client@0.4.0-pre.5#adapters/qunit*/
...
/*testee-client@0.4.0-pre.5#adapters/jasmine-legacy*/
...
/*testee-client@0.4.0-pre.5#adapters/jasmine*/
...
/*testee-client@0.4.0-pre.5#adapters/mocha*/
...
/*testee-client@0.4.0-pre.5#index*/
